...
#
# **** Special user permission required to create submission on behalf of another user
# try:
#     generate_and_load_submissions(enrollments_by_course, assignments_by_course)
# except Exception as ex:
#     logger.exception(ex)
#
